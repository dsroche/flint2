...
void _fmpz_mod_poly_transp_vandermonde_precomp(fmpz* bb, slong blen,
        const fmpz* vv_inv,
...
void _fmpz_mod_poly_transp_vandermonde(fmpz* bb, slong blen,
        const fmpz* vv, const fmpz* xx, slong len, const fmpz_t p)
{
    ...
    else
    {
        ...
        _fmpz_mod_poly_transp_vandermonde_precomp(bb, blen,
