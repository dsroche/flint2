...
main(void)
{
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_fdiv_si_si(b, a, j, i);
        fmpz_spoly_mon_fdiv_si_si(a, a, j, i);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_fdiv_si_si(b, a, g, f);
        fmpz_spoly_scalar_fdiv_si(a, a, g);
