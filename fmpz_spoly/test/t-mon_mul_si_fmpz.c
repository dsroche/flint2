...
main(void)
{
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_si_fmpz(b, a, i, n);
        fmpz_spoly_mon_mul_si_fmpz(a, a, i, n);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_si_fmpz(b, a, f, e);
        fmpz_spoly_scalar_mul_si(a, a, f);
