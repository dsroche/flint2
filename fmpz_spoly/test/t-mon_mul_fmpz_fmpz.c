...
/******************************************************************************
  ...
  Authored 20015 by A. Whitman Groves; US Government work in the public domain.
...
main(void)
{
    ...
    flint_printf("mon_mul_fmpz_fmpz....");
    fflush(stdout);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_fmpz_fmpz(b, a, m, n);
        fmpz_spoly_mon_mul_fmpz_fmpz(a, a, m, n);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_fmpz_fmpz(b, a, d, e);
        fmpz_spoly_scalar_mul(a, a, d);

        for(i = 0; i < a->length; i++)
        {
          fmpz_add(a->expons + i, a->expons + i, e);
        }
