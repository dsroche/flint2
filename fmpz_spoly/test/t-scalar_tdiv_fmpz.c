...
main(void)
{
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        if(!fmpz_is_zero(n))
        {
            fmpz_spoly_scalar_tdiv(b, a, n);
            fmpz_spoly_scalar_tdiv(a, a, n);
        }
        else
        {
            fmpz_spoly_set(b, a);
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_scalar_tdiv(b, a, n1);
        _fmpz_vec_scalar_tdiv_q_fmpz(a->coeffs, a->coeffs, a->length, n1);
