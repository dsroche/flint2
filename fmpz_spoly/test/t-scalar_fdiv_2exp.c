...
main(void)
{
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_scalar_fdiv_2exp(b, a, n);
        fmpz_spoly_scalar_fdiv_2exp(a, a, n);
    ...
    /* Compare with fmpz_spoly_scalar_fdiv_si */
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        fmpz_spoly_t a, b;
        fmpz_t c;
        ...
        fmpz_spoly_scalar_fdiv_2exp(b, a, n);
        _fmpz_vec_scalar_fdiv_q_2exp(a->coeffs, a->coeffs, a->length, n);
