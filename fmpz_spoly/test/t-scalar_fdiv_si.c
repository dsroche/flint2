...
main(void)
{
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        if(n1 != 0)
        {
            fmpz_spoly_scalar_fdiv_si(b, a, n1);
            fmpz_spoly_scalar_fdiv_si(a, a, n1);
        }
        else
        {
            fmpz_spoly_set(b, a);
    ...
    for (i = 0; i < 1000 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_scalar_fdiv_si(b, a, n);
        _fmpz_vec_scalar_fdiv_q_si(a->coeffs, a->coeffs, a->length, n);
