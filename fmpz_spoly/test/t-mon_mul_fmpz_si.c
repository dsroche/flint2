...
main(void)
{
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_fmpz_si(b, a, m, i);
        fmpz_spoly_mon_mul_fmpz_si(a, a, m, i);
    ...
    for (i = 0; i < 100 * flint_test_multiplier(); i++)
    {
        ...
        fmpz_spoly_mon_mul_fmpz_si(b, a, d, f);
