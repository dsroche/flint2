...
main(void)
{
    ...
    {
        fmpz_spoly_t poly1, poly2, res1, res2;

        fmpz_spoly_init(poly1);
        fmpz_spoly_init(poly2);
        fmpz_spoly_init(res1);
        fmpz_spoly_init(res2);

        _fmpz_spoly_reserve(poly1, 4);
        _fmpz_spoly_reserve(poly2, 3);
        _fmpz_spoly_reserve(res1, 5);
        _fmpz_spoly_reserve(res2, 5);
        ...
        _fmpz_spoly_normalise(res1);

        fmpz_spoly_mul_OS(res2, state, poly1, poly2);
        
        flint_printf("\npoly1: "), fmpz_spoly_print(poly1);
        flint_printf("\npoly2: "), fmpz_spoly_print(poly2);
        flint_printf("\nres1: "), fmpz_spoly_print(res1);
        flint_printf("\nres2: "), fmpz_spoly_print(res2);
        flint_printf("\n");


        result = fmpz_spoly_equal(res1, res2);
        ...
        fmpz_spoly_clear(poly1);
        fmpz_spoly_clear(poly2);
        fmpz_spoly_clear(res1);
        fmpz_spoly_clear(res2);
    }
