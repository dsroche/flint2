...
void
fmpz_spoly_mul_heaps(fmpz_spoly_t res, const fmpz_spoly_t poly1, const fmpz_spoly_t poly2)
{
    slong i;
    ...
    if(res == poly1 || res == poly2)
    {
        ...
        fmpz_spoly_mul_heaps(temp, poly1, poly2);
    ...
    {
        fmpz_spoly_mul_heaps(res, poly2, poly1);
        return;
    }
    ...
    
    {
        ...
        _fmpz_spoly_reserve(res, poly1->length*poly2->length);
