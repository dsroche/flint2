    ...
    const fmpz_sparse_t poly2)
{
  ...
  /* h_2 (sparse polynomial interpolation is used here but how?)*/
  ...
  /* NEEDS SPARSE INTERPOLATION LIKE STEP ABOVE */
