...
void 
_fmpz_sparse_sub(fmpz * res_c, fmpz * res_e, slong * res_len, const fmpz * poly1_c, 
...
void
fmpz_sparse_sub(fmpz_sparse_t res, const fmpz_sparse_t poly1,
    const fmpz_sparse_t poly2)
{
  ...
  if (poly1 == res || poly2 == res) 
  {
    ...
    _fmpz_sparse_sub(temp->coeffs, temp->expons, &temp->length, poly1->coeffs,
